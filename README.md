...
Smoke-тест проверяет данные, GLB, миграцию сохранений и достижимость всех 6 уровней. Walk-тест строит сетку проходимости. Browser smoke гоняет Web-сборку с локальным mock Яндекс SDK (нужен Chrome).
